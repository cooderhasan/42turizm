                ...
                <div className="embla__container h-full flex">
                    {slides.map((slide) => (
                        <div className="embla__slide relative h-full flex-[0_0_100%] min-w-0" key={slide.id}>
                            ...
                            {/* Content */}
                            <div className="relative z-10 h-full flex items-center justify-start text-left px-4 md:px-16">
                                <div className="max-w-5xl space-y-8">
                                    <div className="animate-fade-in-up">
                                        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white leading-tight tracking-tight mb-2">
                                            {slide.title}
                                        </h1>
                                        <div className="h-1 w-24 bg-[#d4af37] rounded-full mt-6 mb-6"></div>
                                    </div>

                                    {slide.subtitle && (
                                        <p className="text-lg md:text-2xl text-gray-200 max-w-3xl font-light leading-relaxed tracking-wide animate-fade-in-up delay-100">
                                            {slide.subtitle}
                                        </p>
                                    )}
                                    <div className="flex flex-col sm:flex-row gap-5 justify-start mt-10 animate-fade-in-up delay-200">
                                        <Link
